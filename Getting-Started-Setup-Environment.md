...
### Install the JELLOG CLI

[JELLOG CLI](./CLI.md) is a command line interface that is used to automate some common tasks for JELLOG based solutions. First, you need to install the JELLOG CLI using the following command:
