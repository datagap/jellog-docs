...
```js
import { ConfigStateService, CurrentUserDto, ReplaceableComponents } from '@jellog/ng.core';
import {
...
} from '@jellog/ng.permission-management';
import { LocaleDirection } from '@jellog/ng.theme.shared';
import {
  Component,
...
```html
<jellog-modal [visible]="isVisible" (visibleChange)="onVisibleChange($event)" [busy]="modalBusy">
  <ng-container *ngIf="data.entityDisplayName">
    <ng-template #jellogHeader>
      <h4>
        {%{{{ 'JellogPermissionManagement::Permissions' | jellogLocalization }}}%} -
    ...
    <ng-template #jellogBody>
      <div class="custom-checkbox custom-control mb-2">
        ...
        <label class="custom-control-label" for="select-all-in-all-tabs">{%{{{
          'JellogPermissionManagement::SelectAllInAllTabs' | jellogLocalization
        }}}%}</label>
      </div>
          ...
          <div class="pl-1 pt-1">
            <div class="custom-checkbox custom-control mb-2">
              ...
              <label class="custom-control-label" for="select-all-in-this-tabs">{%{{{
                'JellogPermissionManagement::SelectAllInThisTab' | jellogLocalization
              }}}%}</label>
            </div>
            <hr class="mb-3" />
            <div
    ...
    <ng-template #jellogFooter>
      ...
      <jellog-button iconClass="fa fa-check" (click)="submit()">{%{{{
