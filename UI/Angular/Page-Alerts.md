...
A page alert is useful for displaying an important message to the user. The JELLOG Framework provides an easy way to show the following alert to the user.

![angular-page-alert-example](./images/page-alert-warning-example.png)

You can simply import `PageAlertService` from `@jellog/ng.theme.shared` and utilize it as follows:

```js
import { PageAlertService } from '@jellog/ng.theme.shared';
...
this.service.show({
  type: 'danger',
  message: 'JellogAccount::PagerInfo{0}{1}{2}',
  messageLocalizationParams: ['10', '20', '30'],
  title: 'JellogAccount::EntityNotFoundErrorMessage',
