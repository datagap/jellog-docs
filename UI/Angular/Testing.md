...
JELLOG Angular UI is tested like any other Angular application. So, [the guide here](https://angular.io/guide/testing) applies to JELLOG too. That said, we would like to point out some **unit testing topics specific to JELLOG Angular applications**.
...
```js
import { CoreTestingModule } from "@jellog/ng.core/testing";
import { ThemeBasicTestingModule } from "@jellog/ng.theme.basic/testing";
import { ThemeSharedTestingModule } from "@jellog/ng.theme.shared/testing";
...
```js
// other imports
import { clearPage } from "@jellog/ng.core/testing";
...
```js
// other imports
import { wait } from "@jellog/ng.core/testing";
...
```js
import { clearPage, CoreTestingModule, wait } from "@jellog/ng.core/testing";
import { ThemeBasicTestingModule } from "@jellog/ng.theme.basic/testing";
import { ThemeSharedTestingModule } from "@jellog/ng.theme.shared/testing";
import { ComponentFixture } from "@angular/core/testing";
import {
...
- [JELLOG Community Video - Unit Testing with the Angular UI](https://community.jellog.io/articles/unit-testing-with-the-angular-ui-p4l550q3)
