...
* Install the [DataGap.Jellog.AspNetCore.Mvc.UI.Theme.Basic](https://www.nuget.org/packages/DataGap.Jellog.AspNetCore.Mvc.UI.Theme.Basic) NuGet package to your web project.
* Add `JellogAspNetCoreMvcUiBasicThemeModule` into the `[DependsOn(...)]` attribute for your [module class](../../Module-Development-Basics.md) in the web project.
* Install the [@jellog/aspnetcore.mvc.ui.theme.basic](https://www.npmjs.com/package/@jellog/aspnetcore.mvc.ui.theme.basic) NPM package to your web project (e.g. `npm install @jellog/aspnetcore.mvc.ui.theme.basic` or `yarn add @jellog/aspnetcore.mvc.ui.theme.basic`).
* Run `jellog install-libs` command in a command line terminal in the web project's folder.
...
You can run the following [JELLOG CLI](../../CLI.md) command in **Web** project directory to copy the source code to your solution:

`jellog add-module DataGap.BasicTheme --with-source-code --add-to-solution-file`

----

Or, you can download the [source code](https://github.com/jellogframework/jellog/tree/dev/modules/basic-theme/src/DataGap.Jellog.AspNetCore.Mvc.UI.Theme.Basic) of the Basic Theme, manually copy the project content into your solution, re-arrange the package/module dependencies (see the Installation section above to understand how it was installed to the project) and freely customize the theme based on your application requirements.
