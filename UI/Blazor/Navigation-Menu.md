...
There is a special menu item in the menu that is added by the JELLOG Framework: The *Administration* menu. It is typically used by the pre-built admin [application modules](../../Modules/Index.md):
