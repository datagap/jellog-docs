...
The JELLOG Framework, pre-built themes and modules define some **re-usable razor components and pages**. These pages and components can be replaced by your application or module.
...
{{if UI == "BlazorServer"}}
@using DataGap.Jellog.AspNetCore.Components.Server.BasicTheme.Themes.Basic
{{end}}
{{if UI == "Blazor"}}
@using DataGap.Jellog.AspNetCore.Components.WebAssembly.BasicTheme.Themes.Basic
{{end}}
...
* `@inherits Branding` line inherits the Branding component defined by the [Basic Theme](Basic-Theme.md) (in the {{if UI == "BlazorServer"}}`DataGap.Jellog.AspNetCore.Components.Server.BasicTheme.Themes.Basic`{{end}} {{if UI == "Blazor"}}`DataGap.Jellog.AspNetCore.Components.WebAssembly.BasicTheme.Themes.Basic`{{end}} namespace).
