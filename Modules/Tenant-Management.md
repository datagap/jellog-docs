...
[Multi-Tenancy](../Multi-Tenancy.md) is one of the core features of JELLOG Framework. It provides the fundamental infrastructure to build your own SaaS (Software-as-a-Service) solution. JELLOG's multi-tenancy system abstracts where your tenants are stored, by providing the `ITenantStore` interface. All you need to do is to implement that interface.
...
> Please **refer to the [Multi-Tenancy](../Multi-Tenancy.md) documentation** to understand the multi-tenancy system of the JELLOG Framework. This document focuses on the Tenant Management module.

### About the JELLOG Commercial SaaS Module

The [SaaS Module](https://commercial.jellog.io/modules/DataGap.Saas) is an alternative implementation of this module with more features and possibilities. It is distributed as a part of the [JELLOG Commercial](https://commercial.jellog.io/) subscription.
...
The source code of this module can be accessed [here](https://github.com/jellogframework/jellog/tree/dev/modules/tenant-management). The source code is licensed with [MIT](https://choosealicense.com/licenses/mit/), so you can freely use and customize it.
...
This section can be used as a reference if you want to [customize](../Customizing-Application-Modules-Guide.md) this module without changing [its source code](https://github.com/jellogframework/jellog/tree/dev/modules/tenant-management).
...
- `JellogTenantManagement.Tenants`: Tenant management.
- `JellogTenantManagement.Tenants.Create`: Creating a new tenant.
- `JellogTenantManagement.Tenants.Update`: Editing an existing tenant.
- `JellogTenantManagement.Tenants.Delete`: Deleting an existing tenant.
- `JellogTenantManagement.Tenants.ManageFeatures`: Manage features of the tenants.
...
* `JellogTenants` (also includes the connection string)

## Notices

JELLOG Framework allows to use *database per tenant* approach that allows a tenant can have a dedicated database. This module has the fundamental infrastructure to make that implementation possible (see its source code), however it doesn't implement the application layer and UI functionalities to provide it as an out of the box implementation. You can implement these features yourself, or consider to use the [JELLOG Commercial Saas Module](https://docs.jellog.io/en/commercial/latest/modules/saas) that fully implements it and provides much more business features.

## See Also

* [Multi-Tenancy](../Multi-Tenancy.md)
* [JELLOG Commercial SaaS Module](https://docs.jellog.io/en/commercial/latest/modules/saas)