...
`CmsKitRatingOptions` can be configured in the domain layer, in the `ConfigureServices` method of your [module](https://docs.jellog.io/en/jellog/latest/Module-Development-Basics). Example:
