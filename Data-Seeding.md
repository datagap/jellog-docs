...
JELLOG Framework provides a data seed system that is;
...
> Data seed contributors are automatically discovered by the JELLOG Framework and executed as a part of the data seed process.
