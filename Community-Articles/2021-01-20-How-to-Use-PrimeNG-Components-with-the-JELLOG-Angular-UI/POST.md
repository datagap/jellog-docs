# How to Use PrimeNG Components with the JELLOG Angular UI

## Introduction

In this article, we will use components of the [PrimeNG](https://www.primefaces.org/primeng/) that is a popular UI component library for Angular with the JELLOG Framework Angular UI that will be generated via [JELLOG CLI](https://docs.jellog.io/en/jellog/latest/CLI).
...
I have prepared a sample project that contains more PrimeNG components than described in this article. You can download the source code [on GitHub](https://github.com/jellogframework/jellog-samples/tree/master/PrimengSample).
...
Run the following command to install the JELLOG CLI:
...
Create a new solution named `JellogPrimengSample` by running the following command:

```bash
jellog new JellogPrimengSample -u angular -csf
```

See the [JELLOG CLI documentation](https://docs.jellog.io/en/jellog/latest/CLI) for all available options.

You can also use the Direct Download tab on the [Get Started](https://jellog.io/get-started) page.

## Running the Solution

You can run the solution as described in [here](https://docs.jellog.io/en/jellog/latest/Getting-Started-Running-Solution?UI=NG&DB=EF&Tiered=No).
...
import { eThemeSharedRouteNames } from '@jellog/ng.theme.shared';
//...
...
We have implemented the PrimeNG component library on the JELLOG Angular UI project and used two components on a page in a short time. You can use any PrimeNG components by following the documentation. The JELLOG Angular UI will not block you in any case.
